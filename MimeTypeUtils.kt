...
*/
package com.xiaoxiaoying.kotlinwifi.utils
...
object MimeTypeUtils {
    ...
    fun guessMimeTypeFromExtension(extension: String?): String? {
        ...
        val ext = extension.toLowerCase(Locale.US)
        println("extensionToMimeTypeMap size = " + extensionToMimeTypeMap.size)
    ...
    fun guessExtensionFromMimeType(mimeType: String?): String? {
        ...
        val type = mimeType.toLowerCase(Locale.US)
        return mimeTypeToExtensionMap[type]
    }
    ...
    fun getExtension(fileName: String?): String? {
        if (fileName == null || fileName.isEmpty()) {
            ...
            return if (index < 0) null else fileName.substring(index + 1)
        }
    }
}
