...
final class ImgDrawable extends BitmapDrawable {
  ...
  static void setBitmap(ImageView target, Context context, Bitmap bitmap,
    ...
    ImgDrawable drawable =
        new ImgDrawable(context, bitmap, placeholder, noFade, debugging);
  ...
  ImgDrawable(Context context, Bitmap bitmap, Drawable placeholder,
              boolean noFade, boolean debugging) {
